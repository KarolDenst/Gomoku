...
class AlphaZero:
    ...
    def learn(self):
        for iteration in trange(self.args['num_iterations']):
            ...
            torch.save(self.model.state_dict(), f'{self.args["model_path"]}/model_{iteration}.pt')
            torch.save(self.optimizer.state_dict(), f'{self.args["optimizer_path"]}/optimizer_{iteration}.pt')